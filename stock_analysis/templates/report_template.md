...
Company – Full Writeup

Title and a one‑sentence summary of the thesis/outcome.
...
Summarize legal levers, control mechanics, challenge options, and a practical playbook/pricing matrix if a transaction is contemplated.
...
Who controls economic vs voting rights; key vehicles (foundations/holdcos/trusts); recent changes.
...
Coverage window, major regimes/events, P/B regime notes if BVPS available.
...
TABLE: Divisional Volumes/Units Over Six Years (if relevant)  
TABLE: Turnover by Division Over Six Years  
TABLE: EBIT/EBITDA by Division Over Six Years

Segment and geo mix, trends (growth/margins), concentration issues, and resegmentations.
...
CFO, Capex, FCF trends; sustainability and one‑offs. Show acquisitions/disposals vs CFO coverage.
...
Cash/cash‑equivalents/marketable securities, implied yield, net cash (if relevant), restrictions/encumbrances.
...
Haircuts by asset class, liabilities settlement, costs, net to equity per share. State conservative assumptions.
...
Structure, leverage/dilution, entry/exit assumptions, IRRs, and stakeholder outcomes.
...
Who held what when; changes in control/float.
...
Notable insider/major‑holder activity and patterns; any signaling implications.
